...
"""
This module provides job-details of a workflow from Itential Automation Platform
"""
...
def get_workflow_job_details(module):
    """
        :param module:
    ...
    url = transport_protocol + "://" + module.params['iap_fqdn'] + ":" + module.params[
        'iap_port'] + "/workflow_engine/job/" + module.params['job_id'] + "/deep" + "?token=" \
    ...
    module.exit_json(changed=True, msg={"jobId": module.params['job_id']},
...
def main():
    ...
    get_workflow_job_details(module)
